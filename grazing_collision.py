...
# set initial velocity of cluster B particles so that it grazes cluster A
alpha = np.arctan(1/4)  # see working out in notes - makes centre of cluster hit top of other
# want v to be same mag in x direction so that collision is at roughly the same time
# then need other velocity to be a quarter of this as the centre needs to move 20pc rather than 80 to hit the top
# and for this to happen at the same time we need to scale velocity accordingly
velocities[n_particles:2*n_particles,:,0] = [500,0,500/4]
...
plt.legend()
plt.savefig("Final2DGrazing.png", bbox_inches = 'tight', dpi = 1000)
...
plt.ylim([-6e17,6e17])
plt.legend()
plt.savefig("Final2DGrazing(zoomed).png", bbox_inches = 'tight', dpi = 1000)
...
plt.xlim([-6e18,6e18])
plt.ylim([-6e18,6e18])
plt.savefig("Zoomed out grazing Initial and Final Positions of Stars in a Clusters at Different Times2D.png", bbox_inches = 'tight', dpi = 1000)
...
plt.xlim([-6e18,6e18])
plt.ylim([-6e18,6e18])
plt.savefig("Zoomed out XZ grazing Initial and Final Positions of Stars in a Clusters at Different Times2D.png", bbox_inches = 'tight', dpi = 1000)
...
plt.scatter(positions[n_particles:2*n_particles,0:1,-1],positions[n_particles:2*n_particles,1:2,-1], label = "B Final", s = markersize, color = 'magenta')
plt.legend()
plt.savefig("Initial and Final Positions of Stars in a Clusters at Different Times2D Grazing.png", bbox_inches = 'tight', dpi = 1000)
...
plt.xlim([-1.5e18, 1.5e18])
plt.legend()
plt.savefig("Initial and Final Positions of Stars in a Cluster at Different Times Grazing (zoomed2D).png", bbox_inches = 'tight', dpi = 1000)
...
plt.legend()
plt.savefig("Energy Graph for Grazing.png", bbox_inches = 'tight', dpi = 1000)
# 3D graphs attempt
xlim = [-1.2e18,1.2e18]
ylim = [-6e17,6e17]
zlim = [-6e17,6e17]
...
plt.legend()
#plt.show()
plt.savefig("Initial and final 2piece3D grazing(zoomed to intial).png", bbox_inches = 'tight', dpi = 1000)
ax.clear()
plt.figure()
ax = plt.axes(projection = '3d')
ax.scatter3D(positions[0:n_particles,0:1,0],positions[0:n_particles,1:2,0],positions[0:n_particles,2:3,0], s = markersize,marker = '+' , label = 'A Initial',color = 'blue')
...
plt.savefig("Initial and final 2piece3D grazing.png", bbox_inches = 'tight', dpi = 1000)
...
plt.savefig("Zoomed out Initial and final 2piece3D grazing.png", bbox_inches = 'tight', dpi = 1000)
...
plt.savefig("NEW Zoomed out Initial and final 2piece3D grazing.png", bbox_inches = 'tight', dpi = 1000)
...
ax.set_zlim(zlim)
plt.legend()
plt.savefig("Final3DGrazing(zoomed).png", bbox_inches = 'tight', dpi = 1000)
plt.close()
plt.figure()
ax = plt.axes(projection = '3d')
ax.scatter3D(positions[0:n_particles,0:1,-1],positions[0:n_particles,1:2,-1],positions[0:n_particles,2:3,-1], s = markersize, label = 'A',color = 'blue')
...
ax.set_zlabel("Z (m)", fontsize = 10, labelpad = 15)
plt.legend()
plt.savefig("Final3DGrazing.png", bbox_inches = 'tight', dpi = 1000)
'''
plt.show()
'''
...
#plt.show()
ani.save("energy_graph_grazing.mp4", writer = writer)
...
ani.save("cluster_collision3D_grazing.mp4", writer = writer)
...
ani.save("cluster_collision3D_zoomed_out_grazing.mp4", writer = writer)
'''
#plt.show()
...
#plt.legend()
plt.savefig("E percentage vs Time grazing.png", bbox_inches = 'tight', dpi = 1000)
...
plt.legend()
plt.savefig("Virial Ratio vs Time grazing.png", bbox_inches = 'tight', dpi = 1000)
...
plt.figure()
plt.plot(times, av_v_total, label = "Total")
plt.plot(times, av_v_a, label = "Cluster A")
plt.plot(times, av_v_b, label = "Cluster B")
plt.xlabel("Time (s)")
plt.ylabel("Velocity (ms$^(-1)$)")
plt.legend()
plt.savefig("Av Vels grazing.png")
...
for i in range(0, 2*n_particles):
    plt.plot(times, np.sqrt(shift_v[i,0:1,:] **2 + shift_v[i,1:2,:] **2 + shift_v[i,2:3,:] **2)[0])
...
plt.savefig("Average Distance of Stars from COM grazing.png", bbox_inches = 'tight', dpi = 1000)

for i in range(0, 2*n_particles):
    plt.plot(times, d_from_com[i,0,:])
plt.xlabel("Times (s)")
plt.ylabel("Distance from COM (m)")
plt.savefig("Distance from COM for Each Star grazing.png", bbox_inches = 'tight', dpi = 1000)
